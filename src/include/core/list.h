...
typedef void (*list_apply) (void *value);
void list_walk(list_s *list, list_apply func);

typedef void (*list_apply_with_state) (void *value, void *state);
void list_walk_with_state(list_s *list, list_apply_with_state func, void *state);
